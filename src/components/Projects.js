...
import loveImage2 from '.././images/loveImage2.jpeg'
...
function Projects() {
  return (
    <div>
      ...
      <Work image={loveImage2} altImage='love probability generator' jobTitle='Personal Project' companyName='Love Probability Generator' workDesc='React, Router, Express, Axios, CSS' redirect='https://github.com/kylejosephswe/LoveProbabilityGenerator' />

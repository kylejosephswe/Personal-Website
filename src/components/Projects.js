...
function Projects() {
  return (
    <div>
      ...
      <Work image={NikeLogo} altImage='Nike Sneaker Gallery' jobTitle='Personal Project' companyName='Nike Sneaker Gallery' workDesc='E-commerce sneaker website made with the intention of improving my design skills' skills="TypeScript, React, Router, Context API, Firebase, CSS" redirect='https://sneaker-gallery.web.app/' />
      ...
      <Work image={Keshi} altImage='Keshi' jobTitle='Personal Project' companyName='Keshi Music Bracket' workDesc='This is a game I developed where you can eliminate songs until you find your favorite Keshi song' skills="TypeScript, Html, Firebase, CSS" redirect='https://keshi-music-bracket.web.app/' />
    </div>
  )
}

...
function Projects() {
  return (
    <div>
      ...
      <Work image={pokemon} altImage='Pokedex' jobTitle='Personal Project' companyName='National Pokedex' workDesc='React, Firebase, CSS' redirect='https://national-pokedex.web.app/' />

...
function Projects() {
  return (
    <div>
      ...
      <Work image={pokemon} altImage='Pokedex' jobTitle='Personal Project' companyName='National Pokédex' workDesc='React, PokéAPI, Firebase, CSS' redirect='https://national-pokedex.web.app/' />

...
function Projects() {
  return (
    <div>
      ...
      <Work image={animeImage} altImage='Meloverna' jobTitle='Personal Project' companyName='Meloverna' workDesc='SQL, Kotlin, Python, Flask, JavaScript, React.js, Jest, JUnit, CSS, Git' redirect='https://anime-retriever.web.app/' />
